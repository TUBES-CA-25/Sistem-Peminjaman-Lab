        ...
        <div class="p-modal-body">
            <div class="p-form-head" style="align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                <div class="p-date-picker" style="flex-grow:1;">
                    ...
                    <input type="date" id="scheduleDate" value="<?= htmlspecialchars($data['selected_date']) ?>" onchange="changeDate(this.value)" />
                </div>
            </div>
                ...
                <form id="bookingForm">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-6" style="padding-right: 6px;">
                            ...
                            <input type="text" class="form-control" id="bookingDate" value="<?= htmlspecialchars($data['selected_date']) ?>" readonly style="border: 1px solid #E2E8F0; border-radius: 6px; font-size: 0.8rem; padding: 8px 10px; background: #fff;">
                        </div>
                        <div class="col-6" style="padding-left: 6px;">
                            ...
                            <input type="text" class="form-control" id="bookingDay" value="<?= strtoupper($data['selected_day']) ?>" readonly style="border: 1px solid #E2E8F0; border-radius: 6px; font-size: 0.8rem; padding: 8px 10px; background: #fff;">
                        </div>
                    </div>
                    
                    <div style="margin-bottom: 10px;">
                        <label style="font-size: 0.7rem; color: #4A5568; margin-bottom: 4px; display: block;">Laboratorium</label>
                        <input type="text" class="form-control" id="bookingLab" value="" readonly style="border: 1px solid #E2E8F0; border-radius: 6px; font-size: 0.8rem; padding: 8px 10px; background: #fff;">
                    </div>
                    ...
                    <div id="slotInfoBox" style="background: #F7FAFC; border-radius: 6px; padding: 10px 12px; border: 1px solid #E2E8F0; margin-bottom: 10px;">
                        <div id="slotInfoText" style="font-weight: 600; font-size: 0.75rem; color: #2D3748;">Slot kosong: 07:00-18:25</div>
                    ...
                    <div style="margin-bottom: 16px;">
                        ...
                        <input type="text" class="form-control" id="namaKegiatan" value="" placeholder="Nama kegiatan" style="border: 1px solid #E2E8F0; border-radius: 6px; font-size: 0.8rem; padding: 8px 10px;">
                    </div>
