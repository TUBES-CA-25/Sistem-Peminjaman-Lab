            ...
            <tbody>
                ...
                foreach ($data['riwayat'] as $item): ?>
                    ...
                    $dataLengkap = [
                        ...
                        'proposal' => BASE_URL . '/' . $item['file_proposal'],
                        'status' => $item['status'],
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="small text-muted"><i class="bi bi-person me-1"></i> <?= $item['jumlah_peserta']; ?>
                                Peserta</div>
                        </td>
                        <td>
                            <div class="small">
                                <span class="text-primary fw-bold">Mulai:</span>
                        ...
                        <td class="text-center">
                            <?php if (!empty($item['file_proposal'])): ?>
                                <a href="<?= BASE_URL; ?>/<?= $item['file_proposal']; ?>" target="_blank"
                                    class="btn btn-sm btn-outline-danger py-0 px-2" style="font-size: 0.8rem;">
                        ...
                        <td class="text-center">
                            <?php
                            $status = $item['status'];
                            $badge = 'badge-status-wait';
                            $icon = 'hourglass-split';
                            if ($status == 'Disetujui') {
                                $badge = 'badge-status-ok';
                                $icon = 'check-circle';
                            } elseif ($status == 'Ditolak') {
                                $badge = 'badge-status-reject';
                                $icon = 'x-circle';
                            } elseif ($status == 'Menunggu Interview') {
                                $badge = 'badge-status-interview';
                                $icon = 'chat-text';
                            }
                            ?>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-1">
                                ...
                                <button class="btn-action btn-delete"
                                    onclick="tryDelete('<?= $item['id']; ?>', '<?= $status; ?>')" title="Batalkan">
