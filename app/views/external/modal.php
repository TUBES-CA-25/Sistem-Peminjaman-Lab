            ...
            <div class="modal-body p-4">
                <form action="<?= BASE_URL; ?>/external/prosesPinjam" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_kegiatan" placeholder="Contoh: Workshop Python Dasar" required>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4">
                ...
                <h6 class="fw-bold mb-3 mt-4">Detail Pengajuan</h6>
                <div class="bg-light p-4 rounded-3">
                    ...
                    <div class="mt-4">
                        <label class="fw-bold text-secondary mb-2 d-block">Proposal Kegiatan</label>
                        <a href="#" id="det_proposal" target="_blank" class="btn btn-dark w-100 py-2 rounded-pill">
                ...
                <div id="warning_footer" class="detail-section alert alert-warning d-flex gap-3 align-items-start mt-4" style="display: none;">
