        ...
        <div class="row gy-4">
            <div class="col-lg-6">
                ...
                <p class="text-secondary small" style="max-width: 400px;">
                    Mitra terpercaya dalam dunia pendidikan dan penelitian. Kami menyediakan ruang untuk inovasi dan
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled text-secondary small">
                    <li class="mb-2"><span
                            class="material-icons-round fs-6 align-middle me-1 text-primary">location_on</span> Jl.
                        Pendidikan No. 123, Jakarta</li>
                    <li class="mb-2"><span class="material-icons-round fs-6 align-middle me-1 text-primary">email</span>
                        info@iclabs.ac.id</li>
                    <li><span class="material-icons-round fs-6 align-middle me-1 text-primary">phone</span> +62 21 1234
                        5678</li>
                </ul>
            </div>
