    ...
    <div class="auth-card text-center">
        ...
        <form method="post" action="<?= BASE_URL ?>/auth/register">
            <div class="mb-3 text-start">
                ...
                <input type="text" class="form-control custom-input" name="nama" placeholder="Nama Lengkap Anda">
            </div>

            <div class="mb-3 text-start">
                <label class="form-label small fw-semibold text-white-50">Email</label>
                <input type="email" class="form-control custom-input" name="email" placeholder="nama@email.com">
            </div>

            <div class="mb-3 text-start">
                <label class="form-label small fw-semibold text-white-50">Nomor Telepon</label>
                <input type="text" class="form-control custom-input" name="telepon" placeholder="08xxxxxxxxxx">
            </div>

            <div class="mb-3 text-start">
                <label class="form-label small fw-semibold text-white-50">Password</label>
                <input type="password" class="form-control custom-input" name="password" placeholder="Buat password">
            </div>

            <div class="mb-4 text-start">
                <label class="form-label small fw-semibold text-white-50">Konfirmasi Password</label>
                <input type="password" class="form-control custom-input" name="password_confirm"
        ...
        <div class="position-relative my-4">
            ...
            <span
                class="position-absolute top-50 start-50 translate-middle bg-transparent px-2 small text-white-50">ATAS</span>
        </div>

        <p class="small mb-0 text-white-50">
            Sudah punya akun?
            <a href="<?= BASE_URL ?>/auth/login"
                class="text-white fw-bold text-decoration-none border-bottom border-white">Masuk di sini</a>
        </p>
    </div>
</div>
