    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="mb-3">
                    <span class="badge rounded-pill px-3 py-2" style="background-color: #4A90E2; color: white;">
                        <i class="bi bi-star-fill me-1"></i> Fasilitas Terlengkap
                    </span>
                </div>
                <h1 class="display-4 fw-bold mb-3" style="color: #1a1a1a;">
                    Kami Adalah ICLABS
                </h1>
                <p class="fs-5 mb-4" style="color: #2C5F8D; font-style: italic;">
...
<section class="py-5" style="background: linear-gradient(180deg, #F8FBFD 0%, #E8F4FA 100%);">
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="fw-bold mb-3" style="color: #1a1a1a;">
