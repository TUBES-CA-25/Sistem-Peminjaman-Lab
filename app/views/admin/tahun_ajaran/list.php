<?php
// app/views/pages/admin/tahun_ajaran/list.php
?>
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold text-dark">Daftar Tahun Ajaran</h5>
        ...
        <table class="table table-hover align-middle mb-0">
            <thead class="table-light text-secondary">
                <tr>
                    ...
                    <th class="py-3 border-0">Tahun Ajaran</th>
            ...
            <tbody>
                <?php if (empty($tahun_ajaran)): ?>
                    <tr>
                        <td colspan="3" class="text-center py-5 text-muted">Belum ada data tahun ajaran.</td>
                    </tr>
                <?php else: ?>
